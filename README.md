...
This is a datapack for 1.21 that allows you to track players with a Player Tracking Compass. It is crafted with a compass, 4 netherite scrap, 2 echo shards, an ender eye and a wither skull, but you can change the recipe in [its JSON file](./data/playertracker/recipe/player_compass.json).

![Crafting recipe](https://github.com/crxnchy/playertracker/blob/2fde2e18bc0578f4ffd722ac6436f6ecc0900ad6/.share/Screenshot%202026-04-21%20155551.png)
